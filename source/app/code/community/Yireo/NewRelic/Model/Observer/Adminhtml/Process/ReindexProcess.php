...
/**
 * Class Yireo_NewRelic_Model_Observer_Adminhtml_Process_ReindexProcess
 */
class Yireo_NewRelic_Model_Observer_Adminhtml_Process_ReindexProcess extends Yireo_NewRelic_Model_Observer_Generic
{
    /**
     ...
     *
     * @return $this
     * @event controller_action_postdispatch_adminhtml_process_reindexProcess
     */
